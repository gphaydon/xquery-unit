...
import module namespace cm = "http://marklogic.com/common" at "/example3/common.xqy";
import module namespace search="http://marklogic.com/search" at "/example3/search-lib.xqy";
